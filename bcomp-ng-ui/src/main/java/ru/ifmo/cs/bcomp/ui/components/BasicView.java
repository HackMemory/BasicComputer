...
public class BasicView extends BCompPanel {
	...
	public BasicView(GUI gui) {
		...
		super(gui.getComponentManager(), 
			new RegisterProperties[] {
				new RegisterProperties(Reg.AR, REG_ACCUM_X_BV, REG_ADDR_Y_BV, true, false,
				...
				new RegisterProperties(Reg.DR, REG_ACCUM_X_BV, REG_DATA_Y_BV, true, false,
				...
				new RegisterProperties(Reg.IP, REG_IP_X_BV, REG_IP_Y_BV, true, false,
						new GridBagConstraints() {{
							fill = GridBagConstraints.NONE;
							gridy = 2;
							gridx = 4;
				...
				new RegisterProperties(Reg.CR, REG_INSTR_X_BV, REG_ADDR_Y_BV, true, false,
						new GridBagConstraints() {{
							fill = GridBagConstraints.NONE;
							gridy = 1;
							gridx = 4;
				...
				new RegisterProperties(Reg.AC, REG_ACCUM_X_BV, REG_ACCUM_Y_BV, true, true,
						new GridBagConstraints() {{
							fill = GridBagConstraints.NONE;
							gridy = 0;
							gridx = 3;
					...
					new RegisterProperties(Reg.SP, REG_ACCUM_X_BV, 0, true, false,
							new GridBagConstraints() {{
								fill = GridBagConstraints.NONE;
								gridy = 3;
								gridx = 4;
					...
					new RegisterProperties(Reg.BR, 0, 0, true, true,
							new GridBagConstraints(){{
						gridy = 1;
						gridx = 3;
						insets = new Insets(0, 3, 0, 40);
					}}), 
					new RegisterProperties(Reg.PS, 0, 0, true, true,
							new GridBagConstraints(){{
						gridy = 2;
						gridx = 3;
						insets = new Insets(0, 3, 0, 40);
					}}), 
					new RegisterProperties(Reg.IR, 0, 0, true, true,
						 new GridBagConstraints(){{
						gridy = 3;
						gridx = 3;
	...
	public void panelActivate(){
		...
		cpu.setTickFinishListener(ComponentManager.setTickFinishListenerval);
		cpu.setCPUStartListener(null);
		cpu.setCPUStopListener(null);
	}
